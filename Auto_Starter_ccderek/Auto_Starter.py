...
subject_over_est = 0;
line_num = 0;
f = open("./Ensemble_Estimate.txt", "r");
for line in f:
	subject_over_est += float(line);
	line_num += 1;
print "HI Subject Average OverEstimate: %lf" % (subject_over_est/line_num);
# os.system("rm ./Ensemble_Estimate.txt");
...
for line in f:
	subject_over_est += float(line);
	line_num += 1;
print "I Subject Average OverEstimate: %lf" % (subject_over_est/line_num);
# os.system("rm ./Ensemble_Estimate.txt");