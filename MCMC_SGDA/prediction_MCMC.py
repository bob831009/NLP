...
cmd = './libfm-1.42.src/bin/libFM -task r -train ./HI_feature_train.txt -test ./HI_test.txt -iter 2500 -out HI_prediction.txt'
retcode = subprocess.call(cmd, shell=True);

cmd = './libfm-1.42.src/bin/libFM -task r -train ./I_feature_train.txt -test ./I_test.txt -iter 1500 -out I_prediction.txt'
retcode = subprocess.call(cmd, shell=True);

cmd = './libfm-1.42.src/bin/libFM -task r -train ./HIS_feature_train.txt -test ./HIS_test.txt -iter 2000 -out HIS_prediction.txt'
retcode = subprocess.call(cmd, shell=True);

cmd = './libfm-1.42.src/bin/libFM -task r -train ./IS_feature_train.txt -test ./IS_test.txt -iter 2000 -out IS_prediction.txt'
retcode = subprocess.call(cmd, shell=True);

cmd = './libfm-1.42.src/bin/libFM -task c -train ./HI_pass_feature_train.txt -test ./HI_pass_test.txt -iter 2000 -out HI_pass_prediction.txt'
retcode = subprocess.call(cmd, shell=True);

cmd = './libfm-1.42.src/bin/libFM -task c -train ./I_pass_feature_train.txt -test ./I_pass_test.txt -iter 2000 -out I_pass_prediction.txt'
retcode = subprocess.call(cmd, shell=True);

cmd = './libfm-1.42.src/bin/libFM -task c -train ./HIS_pass_feature_train.txt -test ./HIS_pass_test.txt -iter 1500 -out HIS_pass_prediction.txt'
retcode = subprocess.call(cmd, shell=True);

cmd = './libfm-1.42.src/bin/libFM -task c -train ./IS_pass_feature_train.txt -test ./IS_pass_test.txt -iter 2000 -out IS_pass_prediction.txt'
retcode = subprocess.call(cmd, shell=True);
