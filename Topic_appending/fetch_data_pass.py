...
# train_output_dir = './DataBase/' + sys.argv[1] + '_pass_feature_train.txt';
# test_output_dir = './DataBase/' + sys.argv[1] + '_pass_test.txt';
if(len(sys.argv) > 3):
	train_output_dir = os.path.join('./DataBase', sys.argv[1], sys.argv[3], 'pass_feature_train.csv');
	test_output_dir = os.path.join('./DataBase', sys.argv[1], sys.argv[3], 'pass_test.csv');
else:
	train_output_dir = os.path.join('./DataBase', sys.argv[1], 'pass_feature_train.csv');
	test_output_dir = os.path.join('./DataBase', sys.argv[1], 'pass_test.csv');
